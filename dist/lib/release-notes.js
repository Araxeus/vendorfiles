...
allReleases.forEach((release) => {
    assert(release instanceof Object && !!release.tag_name && !!release.body, 'getAllReleases should return a valid array of objects');
...
function getAllReleases(owner, repo) {
    return octokit.repos
        .listReleases({
        owner,
        repo,
